...
import { Publication } from 'types/graphql'
...
export default function PublicationSelect({ defaultValue, onChange }) {
  ...
  const selectedPublication = selected || defaultPublication
            ...
            <Listbox.Button className="relative w-full cursor-default rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 text-left shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm">
              <span className="flex items-center">
                <span className="ml-3 block truncate">
                  {selectedPublication ? selectedPublication.name : '请选择'}
                </span>
              </span>
